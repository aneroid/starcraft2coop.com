...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <h1 data-toc-target="header"><span class="unbold">Commander:</span> Abathur</h1>
    <p id="commanderMotto">Evolution Master</p>
    <?php include("../../includes/reporterror.php");?>
    <div id="links">
        <h2>Sections on this Page</h2>
        <p><a href="#header">Commander: Abathur</a></p>
        ...
        <p class="toc-subsection"><a href="#biomass-calculation">Biomass Calculation</a></p>
        <p class="toc-subsection"><a href="#biomass-effects">Biomass Effects</a></p>
        <p class="toc-subsection"><a href="#toxic-nest-usage">Toxic Nest Usage</a></p>
        <p class="toc-subsection"><a href="#biomass">Biomass Farming</a></p>
    ...
    <h3 id="biomass-calculation">Biomass Calculation</h3>
    ...
    <h3 id="biomass-effects">Biomass Effects</h3>
    ...
    <h3 id="toxic-nest-usage">Toxic Nest Usage</h3>
