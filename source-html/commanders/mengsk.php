...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <h1 data-toc-target="header"><span class="unbold">Commander:</span> Mengsk</h1>
    <p id="commanderMotto">Emperor of the Dominion</p>
    <?php include("../../includes/reporterror.php");?>
    <div id="links">
        <h2>Sections on this Page</h2>
        <p><a href="#header">Commander: Mengsk</a></p>
        ...
        <p class="toc-subsection"><a href="#unit-ranks">Unit Ranks</a></p>
        <p class="toc-subsection"><a href="#laborer-multi-building">Laborer Multi-building</a></p>
        <p class="toc-subsection"><a href="#fastexpand">Fast Expanding</a></p>
        <p class="toc-subsection"><a href="#earthsplitters">Earthsplitters</a></p>
        <p class="toc-subsection"><a href="#mandate-generation">Mandate Generation</a></p>
    ...
    <h3 id="unit-ranks">Unit Ranks</h3>
    ...
    <h3 id="laborer-multi-building">Laborer Multi-building</h3>
    ...
    <h3 id="earthsplitters">Earthsplitters</h3>
    ...
    <h3 id="mandate-generation">Mandate Generation</h3>
