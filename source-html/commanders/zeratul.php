...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <h1 data-toc-target="header"><span class="unbold">Commander:</span> Zeratul</h1>
    <p id="commanderMotto">Dark Prelate</p>
    <?php include("../../includes/reporterror.php");?>
    <div id="links">
        <h2>Sections on this Page</h2>
        <p><a href="#header">Commander: Zeratul</a></p>
        ...
        <p class="toc-subsection"><a href="#calldowns">Artifact Abilities</a></p>
        ...
        <p class="toc-subsection"><a href="#fastexpand">Legion Expands</a></p>
        <p class="toc-subsection"><a href="#artifact">Artifact Spawn Locations</a></p>
        <p class="toc-subsection"><a href="#artifacttrap">Artifact Trapping</a></p>
    ...
    <h3 id="calldowns">Artifact Abilities</h3>
        ...
        <tbody>
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/zeratul/telbruslegion.png" alt="" class="icon" />
                            Telbrus Legion
                        </dt>
                        <dd>
                ...
                <td><p>Generally not as useful as other legions but reasonably effective against Zerg compositions. However, it can be useful on missions like <a href="/missions/deadofnight">Dead of Night</a>.</p></td>
            </tr>
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/zeratul/zorayalegion.png" alt="" class="icon" />
                            Zoraya Legion
                        </dt>
                        <dd>
                ...
                <td><p>Provides great potential for fast-expanding, even on contested maps. If bases are close to each other, players can even clear their ally's expansions.</p></td>
            </tr>
            ...
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/zeratul/serdathlegion.png" alt="" class="icon" />
                            Serdath Legion
                        </dt>
                        <dd>
                ...
                <td><p>Powerful for breaking into tough-to-push fortifications by stealing high-value enemy units. Can also be used to significantly weaken powerful attack waves by spawning on top of it.</p></td>
            </tr>
        </tbody>
    </table>
        ...
        <tbody>
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/zeratul/stasisbeam.png" alt="" class="icon" />
                            Stasis Beam
                        </dt>
                        <dd>
                ...
                <td><p>Can be useful to temporarily take high value targets out of combat while dealing with weaker units first. However, targeting is dependent on the position of the Artifact Holder, making it extremely difficult to land several hits in a straight line.</p></td>
            </tr>
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/zeratul/deploytesseractmonolith.png" alt="" class="icon" />
                            Deploy Tesseract Monolith
                        </dt>
                        <dd>
                ...
                <td>
                    <p><strong class="unbold">Charges:</strong><br /> 1 to start / 3</p>
                    <p><strong class="unbold">Charge Cooldown:</strong><br /> 180 seconds</p>
                </td>
                <td><p>Exremely powerful when projected. Multiple can be used to stun attack waves and help when pushing into enemy bases.</p></td>
            </tr>
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/zeratul/voidsuppressioncrystal.png" alt="" class="icon" />
                ...
                <td><p>Great ability to use when pushing into heavily-fortified positions. Despite the short timer on the crystal, 30 seconds should be more than enough time to clear out high value targets and even an entire base if timed correctly.</p></td>
            </tr>
        </tbody>
    </table>
        ...
        <tbody>
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/zeratul/steadfastreinforcements.png" alt="" class="icon" />
                            Steadfast Reinforcements
                        </dt>
                        <dd>
                            Increases the duration of Zeratul's Legion and Avatar calldowns by 50%.
                        </dd>
                    </dl>
                </td>
                <td><p>Useful for players that prefer to utilize their Legions and Avatars more effectively. However, do note that they do tend to die relatively quickly and therefore, this passive upgrade may not provide as much value as initially intended.</p></td>
            </tr>
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/zeratul/tesseractmatrix.png" alt="" class="icon" />
                            Tesseract Matrix
                        </dt>
                        <dd>
                            Decreases the cooldown of Shade Projection by 25%. Increases the damage absorbed by Shade Barrier by 100%.
                        </dd>
                    </dl>
                </td>
                <td><p>Great passive for players that rely on the Shade Projections to pushing/defending. It can significantly strengthen Zeratul's late-game as well, where cannons are used as a mineral dump.</p></td>
            </tr>
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/zeratul/voidblink.png" alt="" class="icon" />
                            Void Blink
                        </dt>
                        <dd>
                ...
                <td><p>This passive compounds extremely well with the Void Templar's Void Fury upgrade as well as the Ambusher's Vengeance of the Void. Players that intend on using mass Ambusher builds should consider this upgrade.</p></td>
            </tr>
        </tbody>
    </table>
    <p>Fragment 3:</p>
        ...
        <tbody>
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/zeratul/avatarofform.png" alt="" class="icon" />
                            Avatar of Form
                        </dt>
                        <dd>
