...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <h1 data-toc-target="header"><span class="unbold">Commander:</span> Dehaka</h1>
    <p id="commanderMotto">Primal Pack Leader</p>
    <?php include("../../includes/reporterror.php");?>
    <div id="links">
        <h2>Sections on this Page</h2>
        <p><a href="#header">Commander: Dehaka</a></p>
        ...
        <p class="toc-subsection"><a href="#essence-calculation">Essence Calculation</a></p>
        <p class="toc-subsection"><a href="#dehaka-skill-point-upgrades">Dehaka Skill Point Upgrades</a></p>
        <p class="toc-subsection"><a href="#dehaka-stat-point-allocation-order">Dehaka Stat Point Allocation Order</a></p>
        <p class="toc-subsection"><a href="#gene-mutations">Gene Mutations</a></p>
        <p class="toc-subsection"><a href="#devour-mechanics">Devour Mechanics</a></p>
        <p class="toc-subsection"><a href="#essence">Essence Farming</a></p>
        ...
        <tbody>
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/dehaka/summongreaterprimalwurm.png" alt="" class="icon" />
                            Summon Greater Primal Wurm
                        </dt>
                        <dd>
                            Requirements: Glevig's Den<br><br>Summons a powerful temporary defensive Wurm that can detect cloaked and burrowed units.
                        </dd>
                    </dl>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/dehaka/summonglevig.png" alt="" class="icon" />
                            Summon Glevig
                        </dt>
                        <dd>
                            Requirements: Glevig's Den<br><br>Summons the Primal Pack Leader Glevig and a small pack of Primal Zerg. Glevig is a powerful stationary ranged attacker that deals area damage and can relocate his position with Deep Tunnel. Glevig will fight for 60 seconds before returning to his den.
                        </dd>
                    </dl>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/dehaka/summonmurvar.png" alt="" class="icon" />
                            Summon Murvar
                        </dt>
                        <dd>
                            Requirements: Murvar's Den<br><br>Summons the Primal Pack Leader Murvar. Murvar spawns locusts and can create a cloud that slows enemy movement speed and prevents enemy units and structures from attacking or using energy-based abilities. Murvar will fight for 60 seconds before returning to her den.
                        </dd>
                    </dl>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <dl class="ability">
                        <dt>
                            <img src="/images/commanderdata/abilities/dehaka/summondakrun.png" alt="" class="icon" />
                            Summon Dakrun
                        </dt>
                        <dd>
                            Requirements: Dakrun's Den<br><br>Summons the Primal Pack Leader Dakrun. Darkrun is a heavily armored juggernaut that can charge at a target location to deal heavy damage and knock back enemy units in the area. Dakrun will fight for 60 seconds before returning to his den.
                        </dd>
                    </dl>
                </td>
                <td>
    ...
    <h3 id="essence-calculation">Essence Calculation</h3>
    ...
    <h3 id="dehaka-skill-point-upgrades">Dehaka Skill Point Upgrades</h3>
    ...
    <h3 id="dehaka-stat-point-allocation-order">Dehaka Stat Point Allocation Order</h3>
    ...
    <h3 id="gene-mutations">Gene Mutations</h3>
    ...
    <h3 id="devour-mechanics">Devour Mechanics</h3>
