...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <h1 data-toc-target="header"><span class="unbold">Commander:</span> Alarak</h1>
    <p id="commanderMotto">Highlord of the Tal'darim</p>
    <?php include("../../includes/reporterror.php");?>
    <div id="links">
        <h2>Sections on this Page</h2>
        <p><a href="#header">Commander: Alarak</a></p>
        ...
        <p class="toc-subsection"><a href="#no-cooldown-alarak">No Cooldown Alarak</a></p>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P1: <strong>Artificer of Souls</strong></td>
            </tr>
            <tr>
                <th>Advantages</th>
                <td>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P2: <strong>Tyrant Ascendant</strong></td>
            </tr>
            <tr>
                <th>Advantages</th>
                <td>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P3: <strong>Shadow of Death</strong></td>
            </tr>
            <tr>
                <th>Advantages</th>
                <td>
    ...
    <table id="fastExpoTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="centered" colspan="2">Extremely difficult to fast-expand. The general idea is to place a Pylon and overcharge it to clear enemy defenders. Once the defenders are cleared, the Pylon needs to be cancelled before it is complete. Two overcharges are required.</td>
            </tr>
            <tr>
    ...
    <h3 id="no-cooldown-alarak">No Cooldown Alarak</h3>
