...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <h1 data-toc-target="header"><span class="unbold">Commander:</span> Vorazun</h1>
    <p id="commanderMotto">Matriarch of the Nerazim</p>
    <?php include("../../includes/reporterror.php");?>
    <div id="links">
        <h2>Sections on this Page</h2>
        <p><a href="#header">Commander: Vorazun</a></p>
        ...
        <p class="toc-subsection"><a href="#time-stop-effects">Time Stop Effects</a></p>
    ...
    <p>For more information on Vorazun's unit stats, comparison between units and upgrade calculations, visit the <a href="/units/#vorazun">Data Tables</a> page.</p>
    ...
    <h3 id="time-stop-effects">Time Stop Effects</h3>
